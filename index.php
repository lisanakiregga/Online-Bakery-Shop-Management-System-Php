      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            ...
            <p>We have a varirty of cake flavours and free tp order any of your choice. </p>
            <a href="cake-listing.php" class="btn">Order Here <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a> </div>
        </div>
      </div>
    </div>
  </div>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>What we have in stock<span> For You Dear one</span></h2>
